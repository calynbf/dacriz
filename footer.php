<?php
/** Pie de página principal de DACRIZ. @package DACRIZ */
...
?>
<section class="dacriz-brand-footer-bridge" aria-label="Próximo paso">
 <div class="container">
...
<footer id="colophon" class="dacriz-brand-footer">
 <div class="dacriz-brand-footer__texture" aria-hidden="true"></div>
 <div class="container">
  <div class="dacriz-brand-footer__grid">
   <div class="dacriz-brand-footer__intro">
    ...
    <div class="dacriz-brand-footer__social">
   ...
   <div class="dacriz-brand-footer__contact"><h3>Contacto</h3><ul><li><span>⌖</span><span>Lima, Perú<br>Atención nacional e internacional</span></li><li><span>✉</span><a href="mailto:contacto@dacriz.com">contacto@dacriz.com</a></li><?php if ($whatsapp) : ?><li><span>☎</span><a href="https://wa.me/<?php echo esc_attr($whatsapp); ?>" target="_blank" rel="noopener">+<?php echo esc_html($whatsapp); ?></a></li><?php endif; ?></ul></div>
  </div>
  <div class="dacriz-brand-footer__bottom"><p>© <?php echo esc_html(date('Y')); ?> DACRIZ. Todos los derechos reservados.</p><nav><a href="<?php echo esc_url(home_url('/politica-de-privacidad/')); ?>">Privacidad</a><a href="<?php echo esc_url(home_url('/terminos-y-condiciones/')); ?>">Términos</a><a href="<?php echo esc_url(home_url('/libro-de-reclamaciones/')); ?>">Libro de Reclamaciones</a></nav></div>
 </div>
</footer>
</div><!-- #page -->
<?php wp_footer(); ?>
