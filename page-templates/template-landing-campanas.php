...
<main id="primary" class="site-main dacriz-campaign-landing" data-landing-service="<?php echo esc_attr($landing['service']); ?>" data-form-option="<?php echo esc_attr($landing['form_option']); ?>">
 ...
 <section class="dacriz-landing-experience"><?php if ($is_web_landing) : ?><div class="container dacriz-experience-showcase">
  ...
  <div class="dacriz-experience-showcase__copy"><span class="dacriz-landing-kicker">Experiencia comprobable</span><h2>Experiencia técnica con visión de negocio</h2><p>No nos limitamos a instalar una plantilla. Analizamos tu objetivo, organizamos el recorrido del usuario y construimos una solución preparada para crecer.</p><div class="dacriz-experience-stats"><div><strong>100+</strong><span>proyectos completados</span></div><div><strong>360°</strong><span>soluciones digitales integrales</span></div><div><strong>1 a 1</strong><span>atención directa</span></div></div><ul><li>Desarrollo y e-commerce</li><li>Integraciones y servidores</li><li>SEO, analítica y automatización</li></ul><a href="<?php echo esc_url(home_url('/portafolio/')); ?>">Conoce nuestro trabajo <span>→</span></a></div>
