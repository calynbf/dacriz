...
?>
<main id="primary" class="site-main dacriz-ui-contact-page">
 <section class="dacriz-hero dacriz-ui-contact-hero"><div class="container"><div class="section-title">
  <span class="dacriz-ui-contact-eyebrow">Contacto</span><h1>Hablemos de tu proyecto</h1>
  <p>Cuéntanos qué necesitas. Analizaremos tu idea y te responderemos con una propuesta clara, sin compromiso.</p>
 </div></div></section>

 <section class="dacriz-ui-contact-main"><div class="container">
  <div class="dacriz-ui-contact-channels" aria-label="Canales de contacto">
   <?php if ($whatsapp) : ?>
   <a class="dacriz-ui-contact-channel" href="https://wa.me/<?php echo esc_attr($whatsapp); ?>?text=<?php echo rawurlencode('Hola, quiero información sobre sus servicios'); ?>" target="_blank" rel="noopener">
    <span class="dacriz-ui-contact-channel__icon dacriz-ui-contact-channel__icon--whatsapp" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M20.5 3.5A11.8 11.8 0 0 0 1.9 17.7L.3 23.5l5.9-1.6A11.8 11.8 0 0 0 20.5 3.5Zm-8.4 17.1c-1.8 0-3.5-.5-5-1.4l-.4-.2-3.5.9.9-3.4-.2-.4A9.7 9.7 0 1 1 12.1 20.6Zm5.3-7.3c-.3-.1-1.7-.8-1.9-.9-.3-.1-.5-.1-.7.1l-.9 1.1c-.2.2-.4.2-.7.1a7.9 7.9 0 0 1-2.3-1.4 8.5 8.5 0 0 1-1.6-2c-.2-.3 0-.5.1-.6l.5-.6.3-.5c.1-.2 0-.4 0-.5l-.9-2.1c-.2-.6-.5-.5-.7-.5h-.6c-.2 0-.5.1-.8.4-.3.3-1 1-1 2.5s1.1 2.9 1.2 3.1c.1.2 2.1 3.2 5.1 4.5.7.3 1.3.5 1.7.6.7.2 1.4.2 1.9.1.6-.1 1.7-.7 1.9-1.3.2-.7.2-1.2.2-1.3-.1-.1-.3-.2-.6-.3Z"/></svg></span>
    <span><small>Respuesta rápida</small><strong>Conversemos por WhatsApp</strong></span><b aria-hidden="true">↗</b>
   </a><?php endif; ?>
   <a class="dacriz-ui-contact-channel" href="mailto:<?php echo esc_attr($email); ?>">
    <span class="dacriz-ui-contact-channel__icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M3 5h18v14H3V5Zm2 2v.5l7 4.9 7-4.9V7H5Zm14 10V9.9l-7 4.9-7-4.9V17h14Z"/></svg></span>
    <span><small>Respuesta en 24 horas</small><strong><?php echo esc_html($email); ?></strong></span><b aria-hidden="true">↗</b>
   </a>
   <div class="dacriz-ui-contact-channel">
    <span class="dacriz-ui-contact-channel__icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm0 18a8 8 0 1 1 0-16 8 8 0 0 1 0 16Zm1-13h-2v6l5.2 3 .8-1.7-4-2.3V7Z"/></svg></span>
    <span><small>Horario de atención</small><strong>Lun–Vie, 9:00 a 18:00</strong></span>
   </div>
  </div>

  <div class="dacriz-ui-contact-layout">
   <div class="dacriz-ui-contact-copy"><span class="dacriz-ui-kicker">Empecemos</span>
    ...
    <ul class="dacriz-ui-contact-benefits">
   ...
   <div class="dacriz-ui-contact-form-card">
    <div class="dacriz-ui-contact-form-card__heading"><span>Cuéntanos sobre tu proyecto</span><h2>Solicita una cotización</h2><p>Completa el formulario y nos pondremos en contacto contigo.</p></div>
    ...
    ?></div>
    <p class="dacriz-ui-contact-privacy">Tus datos se utilizan únicamente para responder tu consulta.</p>
   </div>
  </div>
 </div></section>

 <section class="dacriz-ui-contact-faq"><div class="container dacriz-ui-contact-faq__layout">
  <div><span class="dacriz-ui-kicker">Preguntas frecuentes</span><h2>Antes de comenzar</h2><p>Información útil para que avancemos con claridad desde el primer contacto.</p></div>
